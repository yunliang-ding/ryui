        ...
        <div style={{ width: '90%', position: 'relative' }}>
          ...
          </div>
          {
            this.props.clear && label && <div className='yui-select-clear' onClick={
              ...
              <i className='iconfont-yui icon-cuo'></i>
            </div>
          }
        </div>
        <div className='yui-select-allow' style={{ right: this.props.clear ? 0 : 4 }}>
          {
            this.state.isOpen
              ?
              <i className={"iconfont-yui icon-xiala1"} />
              :
              <i className={"iconfont-yui icon-xialadown"} />
          }
        </div>
        {
        ...
        label = labelList.map((m, index) => {
          return (
            <span className={"yui-select-compont-multiple-label" + theme} key={m.key} onClick={
              ...
              {m.label}
              <i className={"iconfont-yui icon-guanbi"} style={{ paddingLeft: 4, fontSize: 12, cursor: 'pointer' }} onClick={
                () => {
